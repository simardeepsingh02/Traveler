...
INSERT INTO BookPackage(EmailId,ContactNumber,[Address],DateOfTravel,NumberOfAdults,NumberOfChildren,[Status],PackageId) VALUES('Mayank@gmail.com',2457984315,'310-Lucknow','2023-12-20',2,0,'Booked',900)
INSERT INTO BookPackage(EmailId,ContactNumber,[Address],DateOfTravel,NumberOfAdults,NumberOfChildren,[Status],PackageId) VALUES('poorvi@gmail.com',8465713549,'253-Delhi','2023-12-12',3,0,'Booked',909)
INSERT INTO BookPackage(EmailId,ContactNumber,[Address],DateOfTravel,NumberOfAdults,NumberOfChildren,[Status],PackageId) VALUES('Prabhjeet@gmail.com',4587921568,'310-Agra','2023-08-09',2,1,'Booked',901)

INSERT INTO BookPackage(EmailId,ContactNumber,[Address],DateOfTravel,NumberOfAdults,NumberOfChildren,[Status],PackageId) VALUES('Sagar@gmail.com',3654789125,'310-pune','2023-09-07',2,0,'Booked',902)
...
INSERT INTO Accomodation(BookingId,HotelName,City,NoOfRooms,HotelRating,Price,RoomType) VALUES(4013,'Ashok','Pune',2,4,10000,'Deluxe')
INSERT INTO Accomodation(BookingId,HotelName,City,NoOfRooms,HotelRating,Price,RoomType) VALUES(4011,'Taj','Pune',1,5,15000,'Suite')
...
[VehicleStatus] VARCHAR(30) CONSTRAINT chk_statusid CHECK (VehicleStatus='Booked' OR VehicleStatus='Active' OR VehicleStatus='Closed')
)
...
INSERT INTO Payment(BookingId,TotalAmount,PaymentStatus) VALUES (4011,2000000,'Confirmed')
