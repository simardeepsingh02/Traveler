...
using Traveler.DALayer;
using Traveler.DALayer.Models;
namespace TravelerServices.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class TravelerController : Controller
    {
        TravelerRepo adminBL;
        public TravelerController()
        {
            adminBL = new TravelerRepo();
        }
        #region - READ
        ...
        public JsonResult ValidateLoginEmployee(Employee emp)
        {
            ...
            try
            {
                role = adminBL.EmployeeLogin(emp.EmailId, emp.Password);
            }
            catch (Exception)
            {
                role = -99;
        ...
        public JsonResult GetCustomerDetails(string emailId)
        {
            ...
            try
            {
                customer = adminBL.GetCustomerById(emailId);
            }
            catch (Exception e)
            {
                Console.WriteLine(e.Message);
        ...
        public JsonResult GetPackagesByCategoryId(int categoryId)
        {
            ...
            try
            {
                packageList = adminBL.GetPackageByCategoryId(categoryId);
            }
            catch (Exception)
            {
                packageList = null;
        ...
        public JsonResult GetCustomerByEmail(string emailId)
        {
            ...
            try
            {
                cust = adminBL.GetCustomerById(emailId);
            }
            catch (Exception)
            {
                cust = null;
        ...
        public JsonResult GetHotelRatingsByCity(string city)
        {
            ...
            try
            {
                ratings = adminBL.GetHotelRatingByCity(city);
            }
            catch (Exception)
            {
                ratings = null;
        ...
        public int GetTotal(string bookingId)
        {
            ...
            try
            {
                ...
                total = adminBL.TotalAmount(bkid);
            }
            catch (Exception)
            {
                total = 0;
        ...
        public JsonResult GetCityByPackageDetailsId(string bookingId)
        {
            ...
            try
            {
                ...
                city = adminBL.GetCitiesByPackageDetailsId(pkgDetId);
            }
            catch (Exception)
            {
                city = null;
        ...
        public int AddCustomer(Customer custObj)
        {
            ...
            try
            {
                role = adminBL.RegisterNewCustomer(custObj);
            }
            catch (Exception)
            {
                role = -99;
        ...
        public int AddBookPackage(BookPackage bkPkg)
        {
            ...
            try
            {
                if(adminBL.AddBookPackage(bkPkg))
                bookingId =1 ;
            }
            catch (Exception)
            {
        ...
        public bool AddHotel(Hotel hotel)
        {
            ...
            try
            {
                status = adminBL.AddNewHotel(hotel);
            }
            catch (Exception e)
            {
                Console.WriteLine(e.Message);
        ...
        public bool AddVehicle(Vehicle vehicle)
        {
            ...
            try
            {
                status = adminBL.AddNewVehicle(vehicle);
            }
            catch (Exception)
            {
                status = false;
        ...
        public bool Payment(Payment pay)
        {
            ...
            try
            {
                status = adminBL.PaymentMethod(pay);
            }
            catch (Exception)
            {
                status = false;
        ...
        public bool UpdateProfile(Customer custObj)
        {
            ...
            try
            {
                status = adminBL.EditProfile(custObj);
            }
            catch (Exception)
            {
                status = false;
